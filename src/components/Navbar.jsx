...
import Image from "../../public/images/ed83f5f1e94efb47572d503f53456dcff902b81c-200x32_1.svg";
    ...
    <header className="bg-transparent text-white max-lg:bg-blue-main max-lg:py-8 top-0 lg:absolute w-full lg:pt-[17px] lg:pb-[25px] text-res-body-p1 lg:text-body-p1 z-[9999]  ">
      <div id="main-navigation" className="relative z-[9999]">
        <div className="container flex items-center flex-wrap justify-between">
          <h1>
            <Link aria-label="Go to home page" href="/en" rel="home">
              <Logo />
            </Link>
          </h1>
              ...
              <ul className="flex">
                ...
                <div className="ml-6 my-auto">
                  ...
                  <div className="lg:hidden block w-full">
                    <div className="w-full rounded-[130px] border px-[14px] py-[8px] text-res-body-p1 text-white border-blue-main transition-all duration-75 rounded-[130px]">
